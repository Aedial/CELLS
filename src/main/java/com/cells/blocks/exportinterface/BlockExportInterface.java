 ...
 */
public class BlockExportInterface extends AEBaseTileBlock {

    public BlockExportInterface() {
        super(Material.IRON);
        this.setRegistryName(Tags.MODID, "export_interface");
        this.setTranslationKey(Tags.MODID + ".export_interface");
        this.setCreativeTab(CellsCreativeTab.instance);
        this.setHardness(2.2F);
        this.setResistance(6.0F);
        this.setTileEntity(TileExportInterface.class);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add("§7" + I18n.format("tooltip.cells.export_interface.info"));
    }
    ...
    public boolean onActivated(final World w, final BlockPos pos, final EntityPlayer p,
        ...
        final TileExportInterface tile = this.getTileEntity(w, pos);
        if (tile != null) {
            if (!w.isRemote) {
                p.openGui(Cells.instance, CellsGuiHandler.GUI_EXPORT_INTERFACE, w, pos.getX(), pos.getY(), pos.getZ());
            }
            return true;
        }
