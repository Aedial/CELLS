...
/**
 * GUI widget for rendering fluid filter slots in the Fluid Export Interface.
 * <p>
 * Reads from the host's filter inventory directly and allows clicking to set or clear filters.
 * <p>
...
public class GuiFluidFilterSlot extends GuiCustomSlot implements IJEITargetSlot {
     ...
     */
    public GuiFluidFilterSlot(final IFluidExportInterfaceInventoryHost host, final int displaySlot,
     ...
     */
    public GuiFluidFilterSlot(final IFluidExportInterfaceInventoryHost host, final int slot, final int x, final int y) {
