...
public class BlockFluidExportInterface extends AEBaseTileBlock {
    ...
    public BlockFluidExportInterface() {
        ...
        this.setTileEntity(TileFluidExportInterface.class);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add("§7" + I18n.format("tooltip.cells.export_fluid_interface.info"));
    }
    ...
    public boolean onActivated(final World w, final BlockPos pos, final EntityPlayer p,
        ...
        final TileFluidExportInterface tile = this.getTileEntity(w, pos);
        if (tile != null) {
            if (!w.isRemote) {
                p.openGui(Cells.instance, CellsGuiHandler.GUI_FLUID_EXPORT_INTERFACE, w, pos.getX(), pos.getY(), pos.getZ());
            }
            return true;
        }
