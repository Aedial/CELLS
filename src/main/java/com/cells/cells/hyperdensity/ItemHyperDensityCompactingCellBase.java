...
import com.cells.cells.compacting.CompactingCellInventory;
 ...
 */
public abstract class ItemHyperDensityCompactingCellBase extends Item implements IItemHyperDensityCompactingCell, IItemGroup {
    ...
    public long getBytes(@Nonnull ItemStack cellItem) {
        ...
        return IItemHyperDensityCompactingCell.multiplyWithOverflowProtection(getDisplayBytes(cellItem), BYTE_MULTIPLIER);
    }
    ...
    public long getBytesPerType(@Nonnull ItemStack cellItem) {
        ...
        return IItemHyperDensityCompactingCell.multiplyWithOverflowProtection(displayBpt, BYTE_MULTIPLIER);
    }
