...
public abstract class ItemHyperDensityCellBase extends Item implements IItemHyperDensityCell, IItemGroup {
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        com.cells.util.CellUpgradeHelper.addUpgradeTooltips(getUpgradesInventory(stack), tooltip);
    ...
    public long getBytesPerType(@Nonnull ItemStack cellItem) {
        ...
        if (meta >= 0 && meta < bytesPerType.length) {
            return IItemHyperDensityCell.multiplyWithOverflowProtection(bytesPerType[meta], BYTE_MULTIPLIER);
        }

        return IItemHyperDensityCell.multiplyWithOverflowProtection(bytesPerType[0], BYTE_MULTIPLIER);
    }

    @Override
    public double getIdleDrain() {
        return 1.0; // Slightly higher drain for hyper-density cells
    }
