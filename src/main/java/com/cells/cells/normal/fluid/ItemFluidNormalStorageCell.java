...
/**
 * Normal AE2-style fluid storage cell for tiers beyond standard capacities.
 * Provides 64M, 256M, 1G, 2G fluid storage cells.
 * 
 * These cells behave exactly like standard AE2 fluid cells but with higher capacity.
 */
public class ItemFluidNormalStorageCell extends AEBaseItem implements IStorageCell<IAEFluidStack>, IItemGroup {
    ...
    public ItemFluidNormalStorageCell() {
        setMaxStackSize(64);
        setHasSubtypes(true);
        setMaxDamage(0);
        setCreativeTab(CreativeTab.instance);
        setRegistryName(Tags.MODID, "fluid_normal_storage_cell");
        setTranslationKey(Tags.MODID + ".fluid_normal_storage_cell");
    }
    ...
    public double getIdleDrain() {
        return CellsConfig.fluidNormalIdleDrain;
    }
    ...
    public double getIdleDrain(@Nonnull ItemStack cellItem) {
        ...
        return IDLE_DRAIN[tier] * (CellsConfig.fluidNormalIdleDrain / 3.0);
    }
    ...
    private boolean disassembleDrive(ItemStack stack, EntityPlayer player) {
        ...
        IMEInventoryHandler<IAEFluidStack> inv = AEApi.instance().registries().cell()
        ...
        IItemList<IAEFluidStack> list = inv.getAvailableItems(getChannel().createList());
    ...
    protected ItemStack getCellComponent(int tier) {
        return ItemFluidNormalStorageComponent.create(tier);
    }
    ...
    public static ItemStack create(int tier) {
        ...
        return new ItemStack(ItemRegistry.FLUID_NORMAL_STORAGE_CELL, 1, tier);
    }
